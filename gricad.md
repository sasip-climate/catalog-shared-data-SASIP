# How to access data from GRICAD
 ...
 - For a more direct access, once you have set up a direct access to dahu via [this procedure](https://gricad-doc.univ-grenoble-alpes.fr/en/hpc/connexion/#connecting-to-the-gateways-without-a-password) you can set up a local mounting via the command ```sshfs dahu.ciment:/summer/sasip /an_empty_local_directory```
